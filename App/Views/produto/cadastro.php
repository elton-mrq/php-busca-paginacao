        ...
        <div class="col-md-6">
            ...
            <form action="http://<?php echo APP_HOST; ?>/produto/salvar" method="post" id="form_cadastro">
                ...
                <div class="form-group">
                    ...
                    <option value="Unidade"  <?php echo ($Sessao::retornaValorFormulario('Unidade') == "Unidade") ?
                        "select" : "" ?>>Unidade</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="radio" class="form-check-input" id="status_s" name="status"
                    value="s" checked>
                    <label for="status_n">Desativado</label>
                    <input type="radio" class="form-check-input" id="status_n" name="status"
                    value="n">
                </div>
                ...
                <a href="http://<?php echo APP_HOST; ?>/produto" class="btn btn-info btn-sm">
